...
aws --endpoint-url=http://localhost:4566 sns publish \
    ...
    --message '{"version":"1.0","description":"A prisoner has been received into prison","occurredAt":"2023-10-25T15:21:47+01:00","personReference":"{identifiers=[{type=NOMS, value=A6887DZ}]}","additionalInformation":"{nomsNumber=A6887DZ, reason=ADMISSION, probableCause=REMAND, source=PRISON, details=ACTIVE IN:ADM-N, currentLocation=IN_PRISON, prisonId=LII, nomisMovementReasonCode=N, currentPrisonStatus=UNDER_PRISON_CARE}"}'
